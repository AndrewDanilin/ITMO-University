...
### Реализация: [ParallelMapperImpl](https://github.com/AndrewDanilin/ITMO-University/blob/main/java-advanced/java-solutions/info/kgeorgiy/ja/danilin/concurrent/ParallelMapperImpl.java)
